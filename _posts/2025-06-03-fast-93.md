...
Similarly, lock annotations allow us to programmatically
[convey thread safety requirements](https://clang.llvm.org/docs/ThreadSafetyAnalysis.html)
...
carefully audit even mundate concurrency patterns.
...
*   Extra checks in debug builds / sampling: We want to maintain implementation
    ...
    [proactively find further issues in production](https://dl.acm.org/doi/10.1145/3639477.3640328).
