...
prefer to focus on information that could [change our decision](/fast/94) rather
than gathering unneeded precision that won't.
...
*   Allocation size information from TCMalloc profiles can help tell us about
    ...
    or [container-specific profiles](/fast/26) can give us a sense of what is
    most likely to be encountered and worth optimizing for.
...
profiles are [available for the container](/fast/26), we can be even more
precise.
